...
!
! Last configuration change at 22:41:27 MSK Sat Feb 17 2024
!
version 15.4
...
router bgp 520
 ...
 address-family ipv4
  ...
  neighbor 20.42.0.1 soft-reconfiguration inbound
  neighbor 30.1.0.1 activate
  neighbor 30.1.0.1 soft-reconfiguration inbound
 ...
 address-family ipv6
  ...
  neighbor AS520v6 route-reflector-client
  neighbor AS520v6 next-hop-self
  neighbor AS520v6 soft-reconfiguration inbound
  neighbor 2001:DB8:301:30:1::1 activate
  neighbor 2001:DB8:301:30:1::1 soft-reconfiguration inbound
  neighbor 2001:DB8:2042:20:42::1 activate
  neighbor 2001:DB8:2042:20:42::1 soft-reconfiguration inbound
